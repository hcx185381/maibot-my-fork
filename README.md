...
**[🚀 Railway 一键部署](https://railway.app/new)** （免费额度，10分钟完成）
...
3. 在环境变量中添加：
   ...
   - `SUPERUSERS` = 你的QQ号（多个用逗号分隔）
4. 点击部署，等待启动完成
5. 查看日志获取登录二维码，扫码登录QQ

**📖 详细教程**: [RAILWAY_DEPLOY.md](RAILWAY_DEPLOY.md) - 10分钟快速部署指南
**📚 通用部署指南**: [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md) - 包含所有平台方案

#### 💻 本地/服务器部署

- [🚀 服务器部署教程](DEPLOYMENT_GUIDE.md#方案一云服务器部署推荐) - 适用于云服务器或VPS
- [🚀 Windows本地部署](https://docs.mai-mai.org/manual/deployment/mmc_deploy_windows.html) - 适用于本地开发
